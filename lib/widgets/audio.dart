...
const kUrl1 = 'https://webstudio.tokyo/music01.mp3';
const kUrl2 = 'https://webstudio.tokyo/music02.mp3';
...
class _AudioAppState extends State<AudioApp> {
  ...
  Widget localAsset() {
    return _tab([
      Text('Play Local Asset \'audio1.mp3\':'),
      _btn('Play', () => audioCache.play('audio1.mp3')),
      Text('Loop Local Asset \'audio1.mp3\':'),
      _btn('Loop', () => audioCache.loop('audio1.mp3')),
